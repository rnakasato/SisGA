		...
		try {
			...
			if (customerList != null && !customerList.isEmpty()) {
				for(int i = 0; i< customerList.size();i++){
					customerList.get(i).getTelephones().get(0).setPnumber(customerList.get(i).getTelephones().get(0).getDdd()+customerList.get(i).getTelephones().get(0).getPnumber());
					customerList.get(i).getTelephones().get(1).setPnumber(customerList.get(i).getTelephones().get(1).getDdd()+customerList.get(i).getTelephones().get(1).getPnumber());
				}
			}
		...
		try {
			...
			if( ! StringUtils.isEmpty( code ) ) {
				...
				if( customerList != null && ! customerList.isEmpty() ) {
					...
					customer.getTelephones().get(0).setPnumber(customer.getTelephones().get(0).getDdd() + customer.getTelephones().get(0).getPnumber());
					customer.getTelephones().get(0).setPnumber(customer.getTelephones().get(1).getDdd() + customer.getTelephones().get(1).getPnumber());
				}
			}
