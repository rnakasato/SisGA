		...
		try {
			...
			if (employeeList != null && !employeeList.isEmpty()) {
				for(int i = 0; i< employeeList.size();i++){
					employeeList.get(i).getTelephones().get(0).setPnumber(employeeList.get(i).getTelephones().get(0).getDdd()+employeeList.get(i).getTelephones().get(0).getPnumber());
					employeeList.get(i).getTelephones().get(1).setPnumber(employeeList.get(i).getTelephones().get(1).getDdd()+employeeList.get(i).getTelephones().get(1).getPnumber());
				}
			}
		...
		try {
			...
			if (!StringUtils.isEmpty(code)) {
				...
				if (employeeList != null && !employeeList.isEmpty()) {
					...
					employee.getTelephones().get(0).setPnumber(employee.getTelephones().get(0).getDdd()+employee.getTelephones().get(0).getPnumber());
					employee.getTelephones().get(1).setPnumber(employee.getTelephones().get(1).getDdd()+employee.getTelephones().get(1).getPnumber());
