...
import com.sisga.core.command.impl.CommandDoRule;
...
public class FactoryCommand {
	...
	public static Command build(AbstractEntity entity,String operation) throws ClassNotFoundException{
		if(commandMap == null){
			initCommands();
		}
	...
	public static Command build(AbstractEntity entity,String operation, int parameter) throws ClassNotFoundException{
		if(commandMap == null){
			initCommands();
		}
		Command command = commandMap.get(operation);
	...
	private static void initCommands(){
		...
		commandMap.put(EOperation.DO_RULE, new CommandDoRule());
	}
}
